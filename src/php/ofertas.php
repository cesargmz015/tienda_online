        ...
        <article>
            <section class="main-container">
                ...
                <div class="detalles">
                    ...
                    <br>
                    <br>
                    <button type="button" class="carrito" onclick="agregarCantidadACarrito(<?= $id ?>, <?= $id_usuario ?>, 'ofertas')"><span>Añadir al carrito</span></button>
                </div>
            </section>
            ...
            <section class="seccion-comentarios">
                <form action="" method="post" onsubmit="return agregarComentario(<?= $id ?>, <?= $id_usuario ?>, 'ofertas')">
                    <?php
                    if (isset($_POST["boton-comentario"])) {
                        $texto = $_POST["comentario"];
                        $sudadera->insertarDatos("INSERT INTO comentarios (id_producto, id_usuario, nombre_usuario, comentario, tabla) VALUES ('$id', '$id_usuario', '{$_SESSION["nombre"]}', '$texto', 'ofertas')");
                    }

                    $comentario = $sudadera->obtenerDatos("SELECT nombre_usuario, comentario FROM comentarios WHERE id_producto = '$id' AND tabla = 'ofertas' ORDER BY id_comentario DESC");
